<?php
	...
	function panel(){
		add_menu_page( 'RiverCraft - Configuration', 'RiverCraft', 'activate_plugins', 'rivercraft-panel', 'render_panel', null, 63);
	}
					...
					<div class="theme-option-group">
						<table cellspacing="0" class="widefat option-table">
							...
							<tbody>
								...
								<tr>
									<th scope="row">
										<label for="saltrc">Salt</label>
									</th>
									<td>
										<input type="text" placeholder="Votre salt de JSONAPI" id="saltrc" name="options[saltrc]" value="<?php print(get_option( 'saltrc', '' )); ?>" size="100">
									</td>
								</tr>
							</tbody>					
						</table>
